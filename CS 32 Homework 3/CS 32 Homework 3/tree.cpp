...
#include <iostream>
int main(){
	double a[15] = { 4, 3, 6, -6, 5, -4, 2, 4, -1, 2, 4, -5, -22, 5, 3 };
	int first;
	int second;
	separate(a, 15, 3, first, second);
	for (int i = 0; i < 15; i++){
		std::cout << a[i] << std::endl;
	}
	std::cout << std::endl;
	std::cout << "Seperator is 3\n";
	std::cout << "FirstNotGreater is " << first << " & FirstLess is " << second << std::endl;
}
